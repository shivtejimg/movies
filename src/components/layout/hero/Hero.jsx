...
import heroimg2 from '../../../assets/img/book2.jpg'
import heroimg3 from '../../../assets/img/book3.jpg'
...
const Hero = () => {
    const [isActive, setIsActive] = useState("Movies")
  return (
    <div>
      <section>
            <nav className="flex space-x-6 text-gray-400 font-medium">
                <a href="#" onClick={() => setIsActive('Movies')} className={isActive == 'Movies' ? 'text-gray-700 dark:text-white font-semibold' : 'hover:text-gray-700 dark:hover:text-white'}>Movies</a>
                <a href="#" onClick={() => setIsActive('TvSeries')} className={isActive == 'TvSeries' ? 'text-gray-700 dark:text-white font-semibold' : 'hover:text-gray-700 dark:hover:text-white'}>TV Series</a>
                <a href="#" onClick={() => setIsActive('Animes')} className={isActive == 'Animes' ? 'text-gray-700 dark:text-white font-semibold' : 'hover:text-gray-700 dark:hover:text-white'}>Animes</a>
            </nav>


    <div className='tabContent'>
        <div className={isActive == 'Movies' ? 'block' : 'hidden'}>
        ...
        <div className={isActive == 'TvSeries' ? 'block' : 'hidden'}>
            <div className=" flex flex-col justify-between mt-4 bg-black/10 bg-blend-multiply rounded-3xl h-80 overflow-hidden bg-cover bg-center px-7 pt-4 pb-6 text-white"
        ...
        <div className={isActive == 'Animes' ? 'block' : 'hidden'}>
            <div className=" flex flex-col justify-between mt-4 bg-black/10 bg-blend-multiply rounded-3xl h-80 overflow-hidden bg-cover bg-center px-7 pt-4 pb-6 text-white"
