    ...
    <section className="mt-9">
      ...
      <div className="mt-4 grid grid-cols-2 gap-y-5 sm:grid-cols-3 gap-x-5">
        {movies.map((movie, index) => (
          <div key={index} className="flex flex-col rounded-xl overflow-hidden aspect-square border dark:border-zinc-600">
            <img src={movie.poster} className="h-4/5 object-cover w-full" alt={movie.title} />
